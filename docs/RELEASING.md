...
This runbook prepares and validates versioned GitHub releases. It does not
...
## 6. Confirm repository release settings

For public releases:

- enable private vulnerability reporting;
- require the quality and supply-chain workflows on `main`;
...
Never move a pushed release tag or replace a published asset. Fixes receive a
new patch version such as `1.0.18`.
...
1. confirm `/releases/latest` resolves to the new normal release;
2. verify README installer URLs still resolve;
3. announce the release with links to the changelog and security policy.
